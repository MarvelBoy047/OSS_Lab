...
export function AIAssistantPanel() {
  ...
  return (
    <aside className="w-[400px] flex-shrink-0 bg-[var(--bg-primary)] border-l border-[var(--border-primary)] flex flex-col h-screen">
      ...
      {/* Input Area - Import your AIAssistantInput component */}
      <div className="border-t border-[var(--border-primary)]">
        {/* You can import and use your AIAssistantInput component here */}
        {/* <AIAssistantInput onSendMessage={sendMessage} isLoading={isLoading} /> */}
      </div>
    </aside>
  );
}
